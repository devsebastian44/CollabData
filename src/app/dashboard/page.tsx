            ...
            <div className="flex flex-col items-start justify-between gap-4 lg:flex-row lg:items-center">
              <div className="relative w-full lg:w-96">
                ...
                <Input
                  ...
                  className="h-11 border-border-dark bg-surface-dark pl-12 focus:border-primary"
                  value={searchTerm}
              ...
              <div className="flex flex-wrap items-center gap-3">
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button
                      variant="secondary"
                      className="bg-[#232f48] hover:bg-[#2d3b55]"
                    >
                  ...
                  <DropdownMenuContent align="end">
                    <DropdownMenuItem
                      onSelect={() => setSortOption('createdAt')}
                    >
                      Last Active
                    </DropdownMenuItem>
                ...
                <div className="mx-1 h-6 w-px bg-border-dark"></div>
                <div className="flex gap-1 rounded-lg bg-[#232f48] p-1">
                  <Button
                    size="icon"
                    variant="ghost"
                    className={`${viewMode === 'grid' ? 'bg-background-dark shadow-sm' : 'text-text-secondary'} h-8 w-8`}
                  ...
                  <Button
                    size="icon"
                    variant="ghost"
                    className={`${viewMode === 'list' ? 'bg-background-dark shadow-sm' : 'text-text-secondary'} h-8 w-8`}
