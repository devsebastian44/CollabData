      ...
      <div className="px-6 lg:px-8 py-3 flex items-center justify-between">
        ...
        <div className="hidden md:flex flex-1 justify-center gap-8">
          <nav className="flex items-center gap-6">
            ...
            <Link className="text-slate-900 dark:text-white text-sm font-medium border-b-2 border-primary" href="/dashboard">Projects</Link>
            <Link className="text-slate-500 hover:text-primary dark:text-slate-400 dark:hover:text-white text-sm font-medium transition-colors" href="#">Datasets</Link>
            <Link className="text-slate-500 hover:text-primary dark:text-slate-400 dark:hover:text-white text-sm font-medium transition-colors" href="#">Teams</Link>
          </nav>
        </div>
        <div className="flex items-center gap-4">
          <button className="flex size-10 items-center justify-center rounded-full hover:bg-slate-100 dark:hover:bg-[#232f48] text-slate-500 dark:text-slate-400 transition-colors">
            <Bell />
          </button>
          {userAvatar && (
            <Image
