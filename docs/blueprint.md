...
- Primary color: Blue (#135bec), echoing the collaborative, engineering-focused nature of the app.
- Background color: Light gray (#f6f6f8) for a clean and modern look; dark mode background: Dark gray (#101622).
- Accent color: Teal (#2dd4bf) as a contrasting, analogous accent color for interactive elements.
- Body font: 'PT Sans' (sans-serif) for a warm, readable body.
